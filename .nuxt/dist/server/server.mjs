...
import { $fetch } from "D:/Developer/twitch-overlay/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "D:/Developer/twitch-overlay/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "D:/Developer/twitch-overlay/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "D:/Developer/twitch-overlay/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import { defu } from "D:/Developer/twitch-overlay/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol } from "D:/Developer/twitch-overlay/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CZMAMg4t.js")
  },
  {
    name: "settings",
    path: "/settings",
    component: () => import("./_nuxt/settings-zk1vjeyC.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DG52S_Wc.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CIJ0UnwQ.js"));
