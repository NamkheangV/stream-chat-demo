...
import { $fetch } from 'file://D:/Developer/twitch-overlay/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file://D:/Developer/twitch-overlay/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file://D:/Developer/twitch-overlay/node_modules/h3/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://D:/Developer/twitch-overlay/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file://D:/Developer/twitch-overlay/node_modules/defu/dist/defu.mjs';
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://D:/Developer/twitch-overlay/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://D:/Developer/twitch-overlay/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CZMAMg4t.mjs')
  },
  {
    name: "settings",
    path: "/settings",
    component: () => import('./settings-zk1vjeyC.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DG52S_Wc.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CIJ0UnwQ.mjs'));
