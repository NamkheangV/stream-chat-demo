...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.BgtyoNrU.mjs').then(interopDefault),
  "pages/settings.vue": () => import('./settings-styles.Cg7-bbep.mjs').then(interopDefault),
  "pages/index.vue": () => import('./index-styles.CU7c1mBL.mjs').then(interopDefault),
  "pages/settings.vue?vue&type=style&index=0&scoped=49d9fc9c&lang.css": () => import('./settings-styles.Cg7-bbep.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=0&scoped=8583c229&lang.css": () => import('./index-styles.CU7c1mBL.mjs').then(interopDefault),
